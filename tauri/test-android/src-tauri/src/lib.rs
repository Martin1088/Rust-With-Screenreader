use std::{env::current_dir, fs::{self, OpenOptions}, io::{self, Write}, path::Path};
...
fn testdir() -> String {
    ...
    let testapp = Path::new("/data/data/com.test_android.app/cache/test.txt");
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![greet, testdir])
